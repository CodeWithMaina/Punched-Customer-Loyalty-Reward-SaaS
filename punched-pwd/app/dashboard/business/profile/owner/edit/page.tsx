...
// ═══════════════════════════════════════════════════════════════
//  Owner Profile — Edit
//  Route: /dashboard/business/profile/owner/edit
  ...
  return (
    <div className="max-w-lg mx-auto pb-12">
      ...
      <div className="px-5 pt-5 pb-4 flex items-center gap-3">
        <Link href="/dashboard/business/profile/owner" className="h-9 w-9 rounded-xl border border-[var(--border)] flex items-center justify-center text-[var(--text-secondary)] hover:bg-[var(--border-light)] transition-colors flex-shrink-0">
          <ArrowLeft className="h-4 w-4" />
        </Link>
        <div>
          <h1 className="text-lg font-bold text-[var(--text-primary)]">Edit Owner Profile</h1>
          <p className="text-xs text-[var(--text-tertiary)]">Update your personal account</p>
        </div>
      </div>
